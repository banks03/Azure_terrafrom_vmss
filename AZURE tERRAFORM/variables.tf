...
variable "log_analytics_workspace_sku" {
  description = "SKU for Azure Log Analytics Workspace"
  default     = "PerGB2018"
}

variable "log_analytics_workspace_retention" {
  description = "Retention in days for Azure Log Analytics Workspace"
  default     = 30
}
...
variable "storage_account_tier" {
  description = "Pricing Tier for Azure Storage Account"
  default     = "Standard"
}